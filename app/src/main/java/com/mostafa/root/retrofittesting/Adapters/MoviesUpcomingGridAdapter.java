...
public class MoviesUpcomingGridAdapter extends BaseAdapter {
    List<MovieObjUpcoming> ArrayList;
    Context mContext;
    MovieObjUpcoming mObject;
    int mResource;
    LayoutInflater inflater;

    public MoviesUpcomingGridAdapter(Context context, int resource, List<MovieObjUpcoming> ArrayList) {
        mContext =context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.single_movie_design, null);
